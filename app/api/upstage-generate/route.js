...
- 입력된 핵심 키워드와 활동의 의미 범위 안에서 수행 과정, 참여 태도, 사고 수준, 피드백 반영, 성취 수준을 다양한 관찰 문장으로 전개합니다.
...
- 같은 활동을 서로 다른 관찰 관점으로 풀어 쓰는 것은 허용하되, 입력에 없는 사실인 작품명, 수상, 기관, 수치, 도구, 실험 결과 같은 검증 불가능한 구체 사실은 만들지 않습니다.`;
...
- 입력에 없는 작품명, 수상, 기관, 수치, 도구, 실험 결과 같은 검증 불가능한 구체 사실은 만들지 않음.

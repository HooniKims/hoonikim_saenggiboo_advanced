...
const GRADE_TONE_MARKER_CLASSES = {
    ...
    c: { label: "C 수준 보완", pattern: /단계적인 보완|단계적으로 보완|보완할 필요|보완이 필요|연습이 요구|연습이 필요|연습이 더해지면|익혀 가는 과정|높일 여지|향상이 기대|도달하지 못|이해의 제한/ },
    ...
    // C는 "참여했고 다듬는 중" 프레임을 유지해야 하므로 직접적인 결핍 서술을 금지함
    hard: { label: "직접 결핍 서술", pattern: /도달하지 못|이해의 제한|미흡|부족/ },
};
